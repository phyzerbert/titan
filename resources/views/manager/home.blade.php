                    ...
                    <div class="card mb-4">
                        <div class="card-body flexbox-b">
                            ...
                            <div class="mr-5">
                                ...
                                <div class="text-muted">مجموع المشاريع</div>
                            </div class="mr-3">                            
                            <div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body flexbox-b">
                            ...
                            <div class="mr-3">
                                ...
                                <div class="text-muted">الطلبات المقبولة</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body flexbox-b">
                            ...
                            <div class="mr-5">
                                ...
                                <div class="text-muted">المبالغ المطلوبة</div>
                            </div>
                            <div class="mr-3">
                                <h3 class="font-strong text-success">{{$return['total_approved_money']}}</h3>
                                <div class="text-muted">ماتم الموافقة عليه</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="ibox bg-success">
                        <div class="ibox-body">
                            ...
                            <div class="text-dark">طلبات اليوم المالية</div><i class="la la-money widget-stat-icon text-white"></i>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="ibox bg-info">
                        <div class="ibox-body">
                            ...
                            <div class="text-dark">الطلبات الشهرية</div><i class="la la-money widget-stat-icon text-white"></i>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="ibox">
                        <div class="ibox-head">
                            ...
                            <form action="" class="form-inline" method="post" id="search_form">
                                ...
                                <button type="button" class="btn btn-success btn-sm mr-1" id="btn-reset">إعادة تعيين</button>
                            </form>
                        </div>
                        <div class="ibox-body">
                            <div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ibox ibox-fullheight">
                        <div class="ibox-head">
                            <div class="ibox-title">أحدث الدورات</div>
                        </div>
