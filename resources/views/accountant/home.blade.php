                    ...
                    <div class="card mb-4">
                        <div class="card-body flexbox-b">
                            ...
                            <div class="mr-5">
                                ...
                                <div class="text-muted">عدد الطلبات المالية</div>
                            </div>
                            <div class="mr-3">
                    ...
                    <div class="card mb-4">
                        <div class="card-body flexbox-b">
                            ...
                            <div class="mr-3">
                                ...
                                <div class="text-muted">الموافق عليه</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ibox ibox-fullheight">
                        <div class="ibox-head">
                            <div class="ibox-title">الدورات الحالية</div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="status" data-value="{{$item->status}}">
                                                ...
                                                @elseif ($item->status == 2)
                                                    <span class="badge badge-secondary badge-pill">جاري العمل</span>
