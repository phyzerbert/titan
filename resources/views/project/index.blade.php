                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="text-center py-1">
                                            ...
                                            @endif                  
                                            <a href="{{route('project.detail', $item->id)}}" class="btn btn-sm btn-pink btn-fix btn-manage"><span class="btn-icon text-white"><i class="la la-info-circle"></i>View</span></a>                                            
